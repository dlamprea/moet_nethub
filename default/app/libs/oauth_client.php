 ...
 * oauth_client.php
 *
 * @(#) $Id: oauth_client.php,v 1.47 2013/02/10 09:59:23 mlemos Exp $
 *
 */
...
<class>
	...
	<version>@(#) $Id: oauth_client.php,v 1.47 2013/02/10 09:59:23 mlemos Exp $</version>
...
*/
	...
	var $oauth_user_agent = 'PHP-OAuth-API (http://www.phpclasses.org/oauth-api $Revision: 1.47 $)';
	...
	Function Initialize()
	{
		switch($this->server)
		{
			...
			case 'Nethub':
				...
				$this->dialog_url = 'https://api.nethub.co/';
				$this->append_state_to_redirect_uri = '';
				$this->access_token_url = 'https://api.nethub.co/oauth2/token/';
